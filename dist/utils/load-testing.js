...
class LoadTesting {
     ...
     * @returns 测试结果
     */
    async runFaultInjectionTest(fn, faultOptions, loadOptions) {
        // 包装函数，注入故障
     ...
     * @returns 函数执行结果
     */
    async simulateServiceTimeout(fn) {
        return this.injectFault(fn, {
            type: 'timeout',
...
// 导出单例实例
exports.loadTesting = new LoadTesting();
